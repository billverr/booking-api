...
//		MONDAY("08:00,08:30,09:00,09:30,10:00,10:30,11:00,11:30,12:00,12:30,13:00,13:30,14:00,14:30,15:00,15:30,16:00,16:30,17:00,17:30,18:00,18:30,19:00,19:30,20:00,20:30,21:00,21:30,22:00,22:30,23:00,23:30"),
		MONDAY(WEEKDAY_TIME_SLOTS),
		TUESDAY(WEEKDAY_TIME_SLOTS),
		WEDNESDAY(WEEKDAY_TIME_SLOTS),
		THURSDAY(WEEKDAY_TIME_SLOTS),
		FRIDAY(WEEKDAY_TIME_SLOTS),
		SATURDAY(SATURDAY_TIME_SLOTS),
		SUNDAY(SUNDAY_TIME_SLOTS);
	

		Timeslots(Set<String> timeSlots) {
		...
		public static Timeslots getByDay(int dayNo) {
			switch (dayNo) {
			case 0:
				return MONDAY;
			case 1:
	...
	public static final Set<String> WEEKDAY_TIME_SLOTS = Stream
			.of("08:00", "08:30", "09:00", "09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:00",
					"13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30", "18:00", "18:30",
					"19:00", "19:30", "20:00", "20:30", "21:00", "21:30", "22:00", "22:30", "23:00", "23:30")
			.collect(Collectors.toCollection(HashSet::new));
			public static final Set<String> SATURDAY_TIME_SLOTS = Stream
			.of("08:00", "08:30", "09:00", "09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:00",
					"13:30", "14:00")
			.collect(Collectors.toCollection(HashSet::new));
	public static final Set<String> SUNDAY_TIME_SLOTS = new HashSet<String>();
